<?php
//
// Script per inviare una mail per notificare tutte le caselle al momento in overquota
...
if (is_array($output) && count($output) > 0) {
	...
	$situation_list = implode("<br>", $values);
        ...
        $subject = 'MAILBOX OVERQUOTA - ZIMBRA IRIS.NEIKOS.IT: lista caselle con spazio occupato maggiore o uguale al 95%';
